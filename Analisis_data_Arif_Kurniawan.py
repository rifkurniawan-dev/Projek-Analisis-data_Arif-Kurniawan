  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/rifkurniawan-dev/Projek-Analisis-data_Arif-Kurniawan/blob/main/Analisis_data_Arif_Kurniawan.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "BqWy6fbvnXVg",
        "outputId": "92dbb42b-618b-4c31-f8e5-9b7d63faf43a"
      },
      "execution_count": 142,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-cb1cc452-5527-4acf-8d7e-49503bedb371\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              ...
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-cb1cc452-5527-4acf-8d7e-49503bedb371')\"\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-cb1cc452-5527-4acf-8d7e-49503bedb371 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-cb1cc452-5527-4acf-8d7e-49503bedb371');\n",
              "        const dataTable =\n",
              ...
              "\n",
              "\n",
              "<div id=\"df-b6781858-9b8a-48ae-8542-6a9800b9396e\">\n",
              "  <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-b6781858-9b8a-48ae-8542-6a9800b9396e')\"\n",
              ...
              "        document.querySelector('#df-b6781858-9b8a-48ae-8542-6a9800b9396e button');\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "8MhzAm55NRZZ",
        "outputId": "8075deeb-d1f1-4138-8f91-197445a787fb"
      },
      "execution_count": 143,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-5d9952ce-8e7f-4c54-aa21-72afc7b3c843\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-5d9952ce-8e7f-4c54-aa21-72afc7b3c843')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-5d9952ce-8e7f-4c54-aa21-72afc7b3c843 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-5d9952ce-8e7f-4c54-aa21-72afc7b3c843');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "<div id=\"df-d7efab09-cb93-46dc-a6d6-06b4954b9f9f\">\n",
              "  <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-d7efab09-cb93-46dc-a6d6-06b4954b9f9f')\"\n",
              "            title=\"Suggest charts\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "    (() => {\n",
              "      let quickchartButtonEl =\n",
              "        document.querySelector('#df-d7efab09-cb93-46dc-a6d6-06b4954b9f9f button');\n",
              "      quickchartButtonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "    })();\n",
              "  </script>\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "L1MWP44srdVF",
        "outputId": "81a2eb77-9e62-4e1a-b625-deb280d15b28"
      },
      "execution_count": 144,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "wc0EucHisu8N",
        "outputId": "c80209a4-0622-4594-9acd-38a44ff3d8a8"
      },
      "execution_count": 145,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "iXY0CFQytPe_",
        "outputId": "88d8c467-2884-489e-ee08-275f9285fe89"
      },
      "execution_count": 146,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "89P4OM0ktm1q",
        "outputId": "e96bf3ba-f82f-4667-d8ac-e1b72b3cfa49"
      },
      "execution_count": 147,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "zHm41L9mttSh",
        "outputId": "1e8d60d2-60c1-466f-c09e-f6387f8da052"
      },
      "execution_count": 148,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-fc4f95b5-ca3b-4616-ad20-11208851aaeb\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-fc4f95b5-ca3b-4616-ad20-11208851aaeb')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-fc4f95b5-ca3b-4616-ad20-11208851aaeb button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-fc4f95b5-ca3b-4616-ad20-11208851aaeb');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "<div id=\"df-98f5b064-8719-407b-b865-705877b9557b\">\n",
              "  <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-98f5b064-8719-407b-b865-705877b9557b')\"\n",
              "            title=\"Suggest charts\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "    (() => {\n",
              "      let quickchartButtonEl =\n",
              "        document.querySelector('#df-98f5b064-8719-407b-b865-705877b9557b button');\n",
              "      quickchartButtonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "    })();\n",
              "  </script>\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "2cf3_7zb2N3W",
        "outputId": "4cdb72ab-337b-4117-b00d-692abb9f28b7"
      },
      "execution_count": 149,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-5d44a51f-33f2-4cf6-b617-40c0801ba96a\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-5d44a51f-33f2-4cf6-b617-40c0801ba96a')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-5d44a51f-33f2-4cf6-b617-40c0801ba96a button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-5d44a51f-33f2-4cf6-b617-40c0801ba96a');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "<div id=\"df-dbcd91e4-2933-413e-b8f1-0b055085596f\">\n",
              "  <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-dbcd91e4-2933-413e-b8f1-0b055085596f')\"\n",
              "            title=\"Suggest charts\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "    (() => {\n",
              "      let quickchartButtonEl =\n",
              "        document.querySelector('#df-dbcd91e4-2933-413e-b8f1-0b055085596f button');\n",
              "      quickchartButtonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "    })();\n",
              "  </script>\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "KkDQIRM8v0Da",
        "outputId": "e8fd864d-2bd9-4f43-9ec3-e8c44a407f66"
      },
      "execution_count": 151,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "2sCEjHrfxd2U",
        "outputId": "ecc8075f-63bc-470b-90d6-697f64e7b15a"
      },
      "execution_count": 153,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "WLk2VZ1f6Aem",
        "outputId": "2183b441-a787-4344-bf89-5ca0204b547d"
      },
      "execution_count": 155,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "<ipython-input-155-debbb5307d84>:2: SettingWithCopyWarning:\n",
            "\n",
            "\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "mrOzaoWG-z4U",
        "outputId": "e77f8008-9276-4fa6-950c-5c89083e7519"
      },
      "execution_count": 157,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "e4olv8dIJvn6",
        "outputId": "5b702293-3a30-48c6-b702-38abd80fbaea"
      },
      "execution_count": 158,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "WfvreFBPKYSo",
        "outputId": "f66c74e6-598f-4553-b3be-ff277747c047"
      },
      "execution_count": 159,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "84fsmRkTNdce",
        "outputId": "16b820a0-dfa0-45a1-e35c-6cd4432719ee"
      },
      "execution_count": 165,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "<ipython-input-165-11e766ae1963>:3: FutureWarning:\n",
            "\n",
            "\n",
            "\n",
        ...
        },
        {
          ...
          "data": {
            ...
            "image/png": "\n"
          },
          "metadata": {}
        },
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "wnosElFsN02N",
        "outputId": "f4444eac-395f-4286-ee9f-abb9144b26a9"
      },
      "execution_count": 167,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "<ipython-input-167-6f8a7ad14894>:3: FutureWarning:\n",
            "\n",
            "\n",
            "\n",
            "Passing `palette` without assigning `hue` is deprecated and will be removed in v0.14.0. Assign the `x` variable to `hue` and set `legend=False` for the same effect.\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Fa8GBLjkP-3T",
        "outputId": "8316dadd-4c62-4e5d-eaf6-afae682d95d0"
      },
      "execution_count": 168,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "51KKMl2KOiqq",
        "outputId": "bbbcc2ce-1bc8-46c5-cc26-21a785c32abb"
      },
      "execution_count": 169,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "YUd4bqq3RNw_",
        "outputId": "c964ec43-1396-42d7-e409-d371af05d924"
      },
      "execution_count": 171,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "cNEQTjOXQxEu",
        "outputId": "1947a923-6f94-4227-efcc-3ff00e5be2af"
      },
      "execution_count": 174,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "V3HZA1LjS-ob",
        "outputId": "2a1f86be-ec09-41f7-a6a2-51290d6183b6"
      },
      "execution_count": 176,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "4sH3CCtvTsch",
        "outputId": "696bcc62-2510-4da5-c308-99801397ab70"
      },
      "execution_count": 178,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "0gXpqKD1Uoxa",
        "outputId": "178767e6-dfad-4460-fa61-81c5f7aaccc5"
      },
      "execution_count": 180,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "jha7SwOBUwIm",
        "outputId": "455f836b-7de0-40a8-8580-eeb157e0c4ab"
      },
      "execution_count": 181,
      "outputs": [
        {
          ...
          "data": {
            "text/html": [
              ...
              "<body>\n",
              "    <div>            <script src=\"https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-AMS-MML_SVG\"></script><script type=\"text/javascript\">if (window.MathJax && window.MathJax.Hub && window.MathJax.Hub.Config) {window.MathJax.Hub.Config({SVG: {font: \"STIX-Web\"}});}</script>                <script type=\"text/javascript\">window.PlotlyConfig = {MathJaxConfig: 'local'};</script>\n",
              "        <script charset=\"utf-8\" src=\"https://cdn.plot.ly/plotly-2.35.2.min.js\"></script>                <div id=\"89713066-4c07-4bf6-84dc-ccb49297e73a\" class=\"plotly-graph-div\" style=\"height:525px; width:100%;\"></div>            <script type=\"text/javascript\">                                    window.PLOTLYENV=window.PLOTLYENV || {};                                    if (document.getElementById(\"89713066-4c07-4bf6-84dc-ccb49297e73a\")) {                    Plotly.newPlot(                        \"89713066-4c07-4bf6-84dc-ccb49297e73a\",                        [{\"alignmentgroup\":\"True\",\"hovertemplate\":\"weathersit=%{x}\\u003cbr\\u003eRata-rata Penyewaan Sepeda=%{y}\\u003cextra\\u003e\\u003c\\u002fextra\\u003e\",\"legendgroup\":\"\",\"marker\":{\"color\":\"#000001\",\"pattern\":{\"shape\":\"\"}},\"name\":\"\",\"offsetgroup\":\"\",\"orientation\":\"v\",\"showlegend\":false,\"textposition\":\"auto\",\"x\":[2,3,4,5,6],\"xaxis\":\"x\",\"y\":[4864.7655677655675,4454.161971830986,4364.048611111111,3722.3703703703704,3851.3333333333335],\"yaxis\":\"y\",\"type\":\"bar\"}],                        {\"template\":{\"data\":{\"candlestick\":[{\"decreasing\":{\"line\":{\"color\":\"#000033\"}},\"increasing\":{\"line\":{\"color\":\"#000032\"}},\"type\":\"candlestick\"}],\"contourcarpet\":[{\"colorscale\":[[0.0,\"#000011\"],[0.1111111111111111,\"#000012\"],[0.2222222222222222,\"#000013\"],[0.3333333333333333,\"#000014\"],[0.4444444444444444,\"#000015\"],[0.5555555555555556,\"#000016\"],[0.6666666666666666,\"#000017\"],[0.7777777777777778,\"#000018\"],[0.8888888888888888,\"#000019\"],[1.0,\"#000020\"]],\"type\":\"contourcarpet\"}],\"contour\":[{\"colorscale\":[[0.0,\"#000011\"],[0.1111111111111111,\"#000012\"],[0.2222222222222222,\"#000013\"],[0.3333333333333333,\"#000014\"],[0.4444444444444444,\"#000015\"],[0.5555555555555556,\"#000016\"],[0.6666666666666666,\"#000017\"],[0.7777777777777778,\"#000018\"],[0.8888888888888888,\"#000019\"],[1.0,\"#000020\"]],\"type\":\"contour\"}],\"heatmap\":[{\"colorscale\":[[0.0,\"#000011\"],[0.1111111111111111,\"#000012\"],[0.2222222222222222,\"#000013\"],[0.3333333333333333,\"#000014\"],[0.4444444444444444,\"#000015\"],[0.5555555555555556,\"#000016\"],[0.6666666666666666,\"#000017\"],[0.7777777777777778,\"#000018\"],[0.8888888888888888,\"#000019\"],[1.0,\"#000020\"]],\"type\":\"heatmap\"}],\"histogram2d\":[{\"colorscale\":[[0.0,\"#000011\"],[0.1111111111111111,\"#000012\"],[0.2222222222222222,\"#000013\"],[0.3333333333333333,\"#000014\"],[0.4444444444444444,\"#000015\"],[0.5555555555555556,\"#000016\"],[0.6666666666666666,\"#000017\"],[0.7777777777777778,\"#000018\"],[0.8888888888888888,\"#000019\"],[1.0,\"#000020\"]],\"type\":\"histogram2d\"}],\"icicle\":[{\"textfont\":{\"color\":\"white\"},\"type\":\"icicle\"}],\"sankey\":[{\"textfont\":{\"color\":\"#000036\"},\"type\":\"sankey\"}],\"scatter\":[{\"marker\":{\"line\":{\"width\":0}},\"type\":\"scatter\"}],\"table\":[{\"cells\":{\"fill\":{\"color\":\"#000038\"},\"font\":{\"color\":\"#000037\"},\"line\":{\"color\":\"#000039\"}},\"header\":{\"fill\":{\"color\":\"#000040\"},\"font\":{\"color\":\"#000036\"},\"line\":{\"color\":\"#000039\"}},\"type\":\"table\"}],\"waterfall\":[{\"connector\":{\"line\":{\"color\":\"#000036\",\"width\":2}},\"decreasing\":{\"marker\":{\"color\":\"#000033\"}},\"increasing\":{\"marker\":{\"color\":\"#000032\"}},\"totals\":{\"marker\":{\"color\":\"#000034\"}},\"type\":\"waterfall\"}]},\"layout\":{\"coloraxis\":{\"colorscale\":[[0.0,\"#000011\"],[0.1111111111111111,\"#000012\"],[0.2222222222222222,\"#000013\"],[0.3333333333333333,\"#000014\"],[0.4444444444444444,\"#000015\"],[0.5555555555555556,\"#000016\"],[0.6666666666666666,\"#000017\"],[0.7777777777777778,\"#000018\"],[0.8888888888888888,\"#000019\"],[1.0,\"#000020\"]]},\"colorscale\":{\"diverging\":[[0.0,\"#000021\"],[0.1,\"#000022\"],[0.2,\"#000023\"],[0.3,\"#000024\"],[0.4,\"#000025\"],[0.5,\"#000026\"],[0.6,\"#000027\"],[0.7,\"#000028\"],[0.8,\"#000029\"],[0.9,\"#000030\"],[1.0,\"#000031\"]],\"sequential\":[[0.0,\"#000011\"],[0.1111111111111111,\"#000012\"],[0.2222222222222222,\"#000013\"],[0.3333333333333333,\"#000014\"],[0.4444444444444444,\"#000015\"],[0.5555555555555556,\"#000016\"],[0.6666666666666666,\"#000017\"],[0.7777777777777778,\"#000018\"],[0.8888888888888888,\"#000019\"],[1.0,\"#000020\"]],\"sequentialminus\":[[0.0,\"#000011\"],[0.1111111111111111,\"#000012\"],[0.2222222222222222,\"#000013\"],[0.3333333333333333,\"#000014\"],[0.4444444444444444,\"#000015\"],[0.5555555555555556,\"#000016\"],[0.6666666666666666,\"#000017\"],[0.7777777777777778,\"#000018\"],[0.8888888888888888,\"#000019\"],[1.0,\"#000020\"]]},\"colorway\":[\"#000001\",\"#000002\",\"#000003\",\"#000004\",\"#000005\",\"#000006\",\"#000007\",\"#000008\",\"#000009\",\"#000010\"]}},\"xaxis\":{\"anchor\":\"y\",\"domain\":[0.0,1.0],\"title\":{\"text\":\"Kategori Cuaca\"}},\"yaxis\":{\"anchor\":\"x\",\"domain\":[0.0,1.0],\"title\":{\"text\":\"Rata-rata Penyewaan Sepeda\"}},\"legend\":{\"tracegroupgap\":0},\"title\":{\"text\":\"Pengaruh Cuaca Terhadap Jumlah Penyewaan Sepeda\"},\"barmode\":\"relative\"},                        {\"responsive\": true}                    ).then(function(){\n",
              "                            \n",
              "var gd = document.getElementById('89713066-4c07-4bf6-84dc-ccb49297e73a');\n",
              "var x = new MutationObserver(function (mutations, observer) {{\n",
              "        var display = window.getComputedStyle(gd).display;\n",
              "        if (!display || display === 'none') {{\n",
              "            console.log([gd, 'removed!']);\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "RhsvwCPSWKi4",
        "outputId": "50d1cb6d-1dfa-4424-ca96-92674a638d9d"
      },
      "execution_count": 182,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "UB8U7Vh_Wxhp",
        "outputId": "f933272d-637d-45ff-fb94-1fec6bfbf087"
      },
      "execution_count": 184,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "2025-03-09 15:58:35.502 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:35.511 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n"
          ]
        },
        {
          "output_type": "execute_result",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Odqo7dasXMo-",
        "outputId": "7944ef7f-de74-415e-d54c-2db2f298e73d"
      },
      "execution_count": 185,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "2025-03-09 15:58:37.689 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:37.691 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:37.692 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:37.693 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n"
          ]
        }
      ]
    },
    {
      ...
      "metadata": {
        ...
        "id": "VgonpolRXOnR",
        "outputId": "56c07de2-67c9-4e42-c64b-271613b32344"
      },
      "execution_count": 186,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "2025-03-09 15:58:43.592 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:43.598 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:43.601 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:43.603 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:43.606 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:43.611 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:43.615 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:58:43.617 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n"
          ]
        }
      ]
    },
    {
      ...
      "metadata": {
        ...
        "id": "BUXSc6jnZIfz",
        "outputId": "a2d814a0-a814-4863-f7ce-2e58a942d02b"
      },
      "execution_count": 187,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "pGlbE3MeZdD9",
        "outputId": "e0686463-2850-4bd6-fa54-cc4032692da6"
      },
      "execution_count": 188,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "X8zl5tmvZ0GM",
        "outputId": "c84cdd63-7774-4577-f643-ef8dcffdfe8f"
      },
      "execution_count": 189,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "7-qK8AzIX3pI",
        "outputId": "22ae1893-6233-460b-f7d8-347b74006e8a"
      },
      "execution_count": 190,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "2025-03-09 15:59:03.359 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:59:03.361 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "<ipython-input-190-640fad3d4145>:10: FutureWarning:\n",
            "\n",
            "\n",
            "\n",
            "Passing `palette` without assigning `hue` is deprecated and will be removed in v0.14.0. Assign the `x` variable to `hue` and set `legend=False` for the same effect.\n",
            "\n",
            "\n",
            "2025-03-09 15:59:03.844 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:59:04.140 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
            "2025-03-09 15:59:04.141 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n"
          ]
        }
      ]
    },
